/*
    module i2rs (based on i2rs.yang)
 */
...
/* The 3 mandatory callback functions: y_i2rs_init, y_i2rs_init2, y_i2rs_cleanup */
...
status_t y_i2rs_init2(void)
{
    return NO_ERR;
}

void y_i2rs_cleanup(void)
{
}
